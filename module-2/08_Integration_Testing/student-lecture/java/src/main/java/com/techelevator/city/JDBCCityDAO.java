...
public class JDBCCityDAO implements CityDAO {
	...
	private long getNextCityId() {
		...
		} else {								// if no value was returned - we have not value for the city id - that's not good
			throw new RuntimeException("Something went wrong while getting an id for the new city");
			// Whenever there is an application error condition we can either ignore it or display an error message
			//								    and continue execution, display an error message and terminate the program
			//									or throw an exception which will terminate the program with
