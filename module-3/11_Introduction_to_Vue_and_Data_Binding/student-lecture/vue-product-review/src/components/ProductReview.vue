<template> <!-- Our html goes here -->
    <div class='main'> <!-- Place our code in the main part of this page -->
        <h2>Product Reviews for {{ title }}</h2> <!-- Use a mustache {{variable}} to indicate you want data from the -->
...
export default {    // Expose data from this code to external processes (like Vue)
    name: 'product-review',  // name for the default exportis the component name in kabob-case
